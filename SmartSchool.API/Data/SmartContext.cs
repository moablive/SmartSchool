        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Professor>()
                .HasData(new List<Professor>(){
                    new Professor(1, 1, "Lauro", "SOBRE1"),
                    new Professor(2, 2, "Roberto", "SOBRE2"),
                    new Professor(3, 3, "Ronaldo", "SOBRE3"),
                    new Professor(4, 4, "Rodrigo", "SOBRE4"),
                    new Professor(5, 5, "Alexandre", "SOBRE5"),
                });
            ...
            builder.Entity<Curso>()
                .HasData(new List<Curso>{
                    ...
                    new Curso(3, "Ciencia da Computação")
                });
